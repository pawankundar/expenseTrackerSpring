...
public class UserRepositoryImpl implements UserRepository {
    ...
    private static final String SQL_FIND_BY_EMAIL_AND_PASSWORD = "SELECT USER_ID, FIRST_NAME, LAST_NAME, EMAIL, PASSWORD FROM ET_USERS WHERE EMAIL = ?";
    ...
    public User findByEmailAndPassword(String email, String password) throws EtAuthException {
        try {
            ...
            User user = jdbcTemplate.queryForObject(SQL_FIND_BY_EMAIL_AND_PASSWORD, new Object[]{email},userRowMapper);
